...
contract MultiSigWallet {
    ...
    receive() external payable {
     ...
     function approv(uint256 txId)external onlyOwner txExists(txId) notApproved(txId) notExecuted(txId){
     ...
     function revoke(uint256 _txId)external onlyOwner  txExists(_txId)
        notExecuted(_txId){
